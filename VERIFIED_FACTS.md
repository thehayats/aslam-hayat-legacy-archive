# Verified Facts — The Aslam Hayat Legacy Archive
...
- ✅ **Family verified** — confirmed directly by the family
- 🔍 **Needs source** — plausible but not yet confirmed with a primary source
- ⏳ **Pending review** — to be researched and confirmed by the family

---

## Verified Facts Currently Used on This Site

| Fact | Status | Notes |
|------|--------|-------|
| Full name: Aslam Hayat | ✅ Family verified | |
| Born: 23 March 1933 | ✅ Family verified | |
| Birthplace: Lahore, Pakistan | ✅ Family verified | |
...
| Maintained regular column in The Miracle newspaper, Vancouver | ✅ Family verified | |
| Column duration: more than 25 years | ✅ Family verified | |
| Total articles authored: 650+ | ✅ Family verified | |
| Active on Facebook | ✅ Family verified | |
| Known in Pakistani-Canadian community as a writer and community member | ✅ Family verified | |
| Passed away: May 30, 2026 | ✅ Family verified | |
| Place of passing: Vancouver, British Columbia, Canada | ✅ Family verified | |
| Died aged 93 | ✅ Family verified | Born 1933, died 2026 |
| Beloved father, grandfather, great-grandfather, and family elder | ✅ Family verified | |
| Close relationship with grandson Zeeshan Hayat | ✅ Family verified | |
| Served as father figure, mentor, teacher, spiritual guide to Zeeshan | ✅ Family verified | |
...
## Facts Removed (Previously Invented — Not to Be Restored Without Verification)

The following claims appeared in earlier versions of this site but were removed because
they were not verified. Do not restore them without family confirmation and a source.

| Removed Claim | Reason Removed |
|---------------|---------------|
| "Chartered Accountant, ICAEW London" | Unverified — specific institute not confirmed |
| Birth year 1945 or 1948 | Incorrect — verified birth year is 1933 |
| Spouse name "Nasreen Akhtar" | Unverified — invented by AI |
| "University of the Punjab" | Unverified |
| "Hajj performed" | Unverified |
| "Emigrated to Canada circa mid-2000s" | Incorrect — verified arrival is 1989 |
| Specific Facebook follower counts | Unverified |
| Specific job titles, departments, or career dates beyond director-level | All unverified |

---

## Information Still Needed From the Family

The following sections are marked as pending on the site and need family input:

- [ ] Specific PCAA roles, department, and service dates
- [ ] Chartered Accountant qualification — name of the specific institute (if family wishes to specify)
- [ ] Spouse name and family details
- [ ] Number of children and their names (if family wishes to share)
- [ ] Original Urdu articles and writings (for the Articles section)
- [ ] Approved photographs (for the Gallery)
- [ ] Facebook posts to archive
- [ ] Additional timeline milestones (specific years for London, PCAA career start/end)
- [ ] Community affiliations beyond The Miracle

---

*This archive is maintained by the family of Aslam Hayat.*
